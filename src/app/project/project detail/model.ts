...
export let projects:Project[]= [
  ...
  {id: '3', tag:[tag.all, tag.cs, tag.sqlserver], name:'watch store', logo:[logo.cs, logo.dotNet, logo.sqlServer], type:type.group, content:' I write backend amin page which applied asp net mvc, linQ, entity framework', source_1:'https://github.com/khanhdoan09/watch-store', source_2:''},
